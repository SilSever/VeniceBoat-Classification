...
from models import VGG_16, SmallerVGGNet
...
#PREPROCESING CNN
data, labels = read_images('sc5-tensorflow', 2, IMAGE_DIMS[0], IMAGE_DIMS[1])
...
#TESTING MODEL
# load the image
path = 'sc5-test-tensorflow/Pleasurecraft/Topa/' #a possible example to test
